          ...
          children: [
            ListTile(
              leading: GestureDetector(
                  ...
                  child: CircleAvatar(radius: 30, backgroundImage:
                    NetworkImage(loadingAccount ? '' :account.image),)),
              title: Text(loadingAccount
                        ? "Loading..."
            ...
            ListTile(
              ...
              trailing: IconButton(
                  onPressed: () async{
                    await AppConfig.auth.sendPasswordResetEmail(email: account.email);
                    ToastDialogue().showToast("An Email has been sent to ${account.email} with instructions to change your password", 0);
            ...
            ListTile(
              ...
              trailing: IconButton(
                  onPressed: () async{
                    await Share.share('check out my website https://example.com', subject: 'Therapy App');
                  }, icon: const Icon(Icons.arrow_forward_ios)),
            ),
          ],
        ),
