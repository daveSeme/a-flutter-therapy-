              ...
              child: Container(
                ...
                child: FirebaseAnimatedList(
                  ...
                  itemBuilder: (context, snapshot, animation, index) {
                    final therapist = Therapist.fromSnapshort(snapshot);
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => DoctorDetailPage(therapist: therapist,)));
      },
      child: Container(
        ...
        child: ListTile(
          leading: CircleAvatar(radius: 25, backgroundImage: NetworkImage(therapist.image),),
          title: Text(
            name,
